...
mysql -u $DB_USER -p$DB_PW -D $DB_NAME -h $(findDb "_db_") -Bse "create table User(id int primary key auto_increment, username varchar(16) not null, password varchar(16) not null);" 2> /dev/null || true
...
mysql -u $DB_USER -p$DB_PW -D $DB_NAME -h $(findDb "db-test") -Bse "create table User(id int primary key auto_increment, username varchar(16) not null, password varchar(16) not null);" 2> /dev/null || true
